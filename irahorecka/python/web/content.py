CONTENT = {
    "home": {
        ...
        "body": {
            ...
            "fourth": "My twin brother is a software engineer and he encouraged me to take up programming, so I did. I eventually moved on to become a lab automation engineer, programming liquid handlers to automate laboratory procedures. I strive to go beyond programming robots, which is why I'm pursuing a higher education in computational biology - to merge my academic background with my passion in programming.",
        },
    },
    "api": {
